 ...
 <ul>
  ...
  <li>
   <dl>
    ...
    <dd><a href="goSystemList" class="active">跳转和推广设置</a></dd>
...
<section class="rt_wrap content mCustomScrollbar">
 ...
 <section>
 	<form action="setToArticle" method="post">
      <h2><strong style="color:grey;">系统设置</strong></h2>
      <ul class="ulColumn2">
       ...
       <li>
        ...
        <input name="aticleName" type="text" class="textbox textbox_295" value="${some.aticleName }"/>
       </li>
       <li>
        <span class="item_name" style="width:120px;">系统网址：</span>
        <input name="urlPath" type="text" class="textbox textbox_295" value="${some.url }"/>
       </li>
