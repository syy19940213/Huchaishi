 ...
 <section>
 	<form action="editArticle" method="post">
      ...
      <ul class="ulColumn2">
       ...
       <li>
        <span class="item_name" style="width:120px;">公告编号：</span>
        <input name="aticleId" type="text" class="textbox textbox_295" value="${aticle.id }" readonly/>
       </li>
       
       <li>
        <span class="item_name" style="width:120px;">公告标题：</span>
        <input name="aticleName" type="text" class="textbox textbox_295" value="${aticle.aticleTitle }" readonly/>
       </li>
       ...
       <li>
        ...
        <div style="width:86% ;margin-left:10%">
       		 ...
       		 <textarea id="content" name="content">${aticle.aticleCenter }</textarea>
