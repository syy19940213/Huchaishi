		...
		<div class="hyzx_dh">
			<div class="hyzx_nav">
				...
				<div class="personal"><a id="edit" href="goUserManage.action">会员管理</a></div>  
					...
					<div class="personal">
						<a id="taobaohao" href="goboundstore" class="on">绑定管理</a>
					</div>
	...
	<div id="ypcon">
		<div class="menu">
			<table cellpadding="0" cellspacing="0">
				<tbody>
					<tr>
				<td class="tab"><a id="m1" href="goboundstore" ><span>绑定店铺</span></a></td>
                <td class="tab"><a id="m4" href="goboundaccount" ><span>绑定账号</span></a></td>
                <td class="tab"><a id="m3" href="boundstorelist.action" class="sb0"><span>店铺列表</span></a></td>
                <td class="tab"><a id="m4" href="boundacountlist.action"><span>账号列表</span></a></td>
						</a></td>
					</tr>
				</tbody>
			</table>
		...
		<div class="ls">
			<table cellpadding="0" cellspacing="0" class="tb">
				<tbody>
					...
					<s:iterator value="#boundList" var ="boundstore">
				     <tr onmouseover="this.className=&#39;on&#39;;"
						onmouseout="this.className=&#39;&#39;;" align="center" class="">

						<td height="30">
							<span style="color:#00F;align:center">${boundstore.boundStorename }&nbsp;&nbsp;</span>
						</td>
						<td>
							<span style="color:#00F">
								<s:if test="#boundstore.boundStatus == 1">
									审核中
								</s:if>
								<s:if test="#boundstore.boundStatus == 2">
									通过审核
								</s:if>
							</span>
						</td>
						<td class="px11 f_gray">
							<img src="${boundstore.boundStorepicture }"   width="100" height="70" alt="" />
						</td>
						
						<td><a href="deletboundstore.action?boundStorename=${boundstore.boundStorename }&boundStoreid=${boundstore.id }"
							onclick="if(!confirm(&#39;确定要删除吗？此操作将不可撤销&#39;)) return false;"><img
								width="16" height="16" src="./img/delete.png" alt=""
								data-hasqtip="3" oldtitle="删除" title=""> </a>
						</td>
					</tr>
				  	</s:iterator>
		...
		<div class="limit">
			总共可添加 <span class="f_b f_red">3</span> 个
		</div>
