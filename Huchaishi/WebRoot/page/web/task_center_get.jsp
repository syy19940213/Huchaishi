...
<body class="rwdt_bg" onload="gotaskcenterget.action">
	...
	<div id="ypcon">
		<div class="menu">
			<table cellpadding="0" cellspacing="0">
				<tbody>
					<tr>
				<td class="tab"><a id="m1" href="gotaskcenter.action" ><span>发布的任务</span></a></td>
                <td class="tab"><a id="m4" href="gotaskcenterget.action" class="sb0"><span>接受的任务</span></a></td>
					...
					<s:if test = "#task.taskShowGet==0">
						...
						<tr onmouseover="this.className=&#39;on&#39;;"
							...
							<td class="px11 f_gray">
								...
								<td>
									<s:if test="#task.taskStauts==2">	
										<a href="successTask.action?taskId=${task.taskId }"
										onclick="if(!confirm(&#39;确定要完成任务吗？此操作将不可撤销&#39;)) return false;">确认完成任务 </a>
									</s:if>
									<s:if test="#task.taskStauts == 5 ">
										<a href="deltaskgetrecord.action?taskid=${task.taskId }"
